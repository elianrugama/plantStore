    ...
    <Card sx={{ display: 'flex', maxHeight: '200px', maxWidth: '1000px', marginLeft: '10px', marginRight: '10px' }}>
      ...
      <Box >
        <CardContent >
          ...
          <div>
          <Typography variant="subtitle2" color="text.secondary" style={{height: '90px',width:"200px" ,overflow : 'auto', marginTop: '10px'}}>
            Pinus Strobus is a type of tropical.
            plant that is tropocal kaksdjasdjasdasjdaslkdjaslkdjaslkdjasdlkasjdklasdjaskldjaskldjaskldasjdklsajdaskdjaskldcjsadklsajdk.
            Pinus Strobus is a type of tropical.
            plant that is tropocal kaksdjasdjasdasjdaslkdjaslkdjaslkdjasdlkasjdklasdjaskldjaskldjaskldasjdklsajdaskdjaskldcjsadklsajdk.
            Pinus Strobus is a type of tropical.
            plant that is tropocal kaksdjasdjasdasjdaslkdjaslkdjaslkdjasdlkasjdklasdjaskldjaskldjaskldasjdklsajdaskdjaskldcjsadklsajdk.
